    ...
    return (
        <View style={stylesIC.container}>
            ...
            <View style={stylesIC.FormsCard}>
                <ScrollView>
                    <Text style={stylesIC.homeconttxt}>INE FRONTAL </Text>
                    <View style={stylesIC.cont2}>
                        <TouchableOpacity style={stylesIC.botonAdd} onPress={pickImage}>
                            <Text style={stylesIC.textBtnSim}>Cargar de galeria </Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={stylesIC.botonAdd} onPress={takePhoto}>
